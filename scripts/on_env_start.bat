...
@REM     @call git clone -b "%update_branch%" https://github.com/easydiffusion/easydiffusion.git sd-ui-files && (
    @call git clone -b "%update_branch%" https://github.com/TiMoscow/teasydiffusion.git sd-ui-files && (
