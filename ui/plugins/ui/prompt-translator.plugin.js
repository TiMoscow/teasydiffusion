...
(function() {
    ...
    let settings = [
        {
            ...
            note: "пишите подсказки на предпочитаемом вами языке, и чтобы он был переведен на английский для достижения наилучших результатов",
            default: "auto",
            options: [
            ],
            icon: "fa-language"
    ...
    promptLanguage.value = localStorage.getItem('prompt_language') == null ? 'auto' : localStorage.getItem('prompt_language')
    if (promptLanguage.value !== 'auto') {
        promptField.style.color = 'lightGrey'
        promptField.style.backgroundColor = 'darkSlateGrey'
        negativePromptField.style.color = 'lightGrey'
